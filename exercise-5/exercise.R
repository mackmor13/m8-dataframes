...
setwd("~/Info_201/m8-dataframes/exercise-5")
...
spending <- sum(grants$total_amount[1:255])
...
largest.recipient <- org[spending == lowest.amount]

# Which organization received the smallest grant?
smalles.recipient <- org[spending == lowest.amount]
